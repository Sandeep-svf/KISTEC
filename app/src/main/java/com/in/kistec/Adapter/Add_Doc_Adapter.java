...
public class Add_Doc_Adapter  extends  RecyclerView.Adapter<Add_Doc_View_Holder>{

    ArrayList<File> data;
    Context context;

    public Add_Doc_Adapter(ArrayList<File> data, Context context) {
        this.data = data;
    ...
    @NonNull
    @Override
    public Add_Doc_View_Holder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.add_doc_view_holder,parent,false);
        return new Add_Doc_View_Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Add_Doc_View_Holder holder, int position) {
            ...
            holder.image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        imageViewDialog.setContentView(R.layout.frame_help);
                        ImageView imageView = imageViewDialog.findViewById(R.id.imageView);
                        LinearLayout backArrow = imageViewDialog.findViewById(R.id.backArrow);
                        ...
                        Log.e("image_path_screening_pdf_open_image","******"+my_file.getAbsolutePath());
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
...
class Add_Doc_View_Holder extends RecyclerView.ViewHolder {
    ImageView image , delete_Data;

    public Add_Doc_View_Holder(@NonNull  View itemView) {
        super(itemView);
        image = itemView.findViewById(R.id.image);
        delete_Data = itemView.findViewById(R.id.delete_Data);
    }
}
